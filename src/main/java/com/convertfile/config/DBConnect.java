...
public class DBConnect {
    ...
    // Database credentials (loaded from application.properties)
    private static final String DB_URL = com.convertfile.service.PropertiesService.getDatabaseUrl();
    private static final String DB_USER = com.convertfile.service.PropertiesService.getDatabaseUsername();
    private static final String DB_PASSWORD = com.convertfile.service.PropertiesService.getDatabasePassword();
